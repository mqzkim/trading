...
argument-hint: "Sprint N 전체 구현 | [데이터셋|평가실행] [--evaluators accuracy,relevance,hallucination,harmfulness,korean] [--judge-model Codex-haiku] [--compare run1,run2]"
...
**6. 회고**: `~/.Codex/projects/.../memory/MEMORY.md` 업데이트
...
eval-engine dataset_abc --evaluators accuracy,hallucination,korean --judge-model Codex-haiku
