---
name: web-scraper
description: "웹사이트에서 구조화된 데이터를 지능적으로 추출. Playwright + Codex Vision 기반. IDEA 2 AI 스크래핑 API와 IDEA 3 디렉토리의 핵심 엔진. Agent 2-1."
...
- AI 기반 지능형 스크래핑 (Codex Vision으로 페이지 구조 이해)
...
- **Codex Vision API** — 페이지 캡처 → 구조 이해 → 데이터 추출
- **Zod** — 추출 데이터 스키마 검증
