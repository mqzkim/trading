---
name: cost-tracker
description: "인프라·API 비용을 실시간 추적하고 예산 초과 방지. Vercel/Supabase/Codex API/Stripe 비용 통합. IDEA 6-E APIPrice SaaS의 내부 버전(Dogfooding). Agent 4-4."
...
- Vercel/Supabase/Codex API/Stripe 빌링 API 데이터 통합
