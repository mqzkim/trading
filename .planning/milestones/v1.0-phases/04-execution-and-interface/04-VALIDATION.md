...
| T4.4 | 04-01 | 1 | EXEC-04 | unit | `pytest tests/unit/test_alpaca_adapter.py -x` | No | Pending |
...
| T4.9 | 04-03 | 2 | EXEC-02 | unit | `pytest tests/unit/test_cli_approve.py -x` | No | Pending |
...
- [ ] `tests/unit/test_alpaca_adapter.py` -- EXEC-04: Bracket order spec creation + validation (BracketSpec -> OrderResult covered in alpaca adapter tests)
...
- [ ] `tests/unit/test_cli_approve.py` -- EXEC-02: CLI approve/execute/monitor commands (CliRunner behavioral tests)
