...
- [ ] **DATA-01**: yfinance 실제 API 데이터 파이프라인 검증 (adjusted close 동작 포함)
- [ ] **DATA-02**: edgartools XBRL 커버리지 소형주 검증
- [ ] **DATA-03**: 데이터 품질 검증 레이어 (결측/이상치 탐지)
...
- [ ] **TECH-01**: RSI/MACD/MA/ADX/OBV 5개 지표를 DDD 스코어링 컨텍스트에 통합
- [ ] **TECH-02**: 기술적 복합 점수 (0-100) 산출 (가중 합산)
- [ ] **TECH-03**: 기존 CompositeScore에 기술 점수 통합 (기본40%/기술40%/센티먼트20%)
